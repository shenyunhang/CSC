...
save_dir = "output/{}_score_test_feedback".format(job_name)
# Directory which stores the snapshot of trained models.
snapshot_dir = "output/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "experiments/logs/{}_score_test_feedback".format(job_name)
# Directory which stores the detection results.
output_result_dir = "data/VOCdevkit{}/results/VOC{}/Main/{}_score_test_feedback/".format(
    YEAR, YEAR, job_name)
